...
<head>
    ...
    <!-- Title  -->
    <title>Present Dreaming | contacto</title>
            ...
            <div class="row h-100 align-items-center">
                <div class="col-12">
                    <div class="breadcumb-content">
                        <h3 class="breadcumb-title">Contactanos</h3>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <div class="contact-form">
                        <form action="enviaremail.php" method="post">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="nombre" id="contact-name" required>
                            </div>
                            <div class="form-group">
                            <label for="contact-number">Celular</label>
                                <input type="number" class="form-control" name="number" id="contact-number"  required>
                            </div>
                            <div class="form-group">
                            <label for="contact-email">Correo Eletronico</label>
                            ...
                            <input type="submit" name="enviar"class="btn south-btn">
                        </form>
                    </div>
                </div>
